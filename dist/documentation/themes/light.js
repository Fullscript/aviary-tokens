 ...
 * Generated on Mon, 18 Sep 2023 13:04:21 GMT
 */
...
module.exports = {text : {emphasis:{
            ...
            hex: "#FFFFFF",
            description: "For use on darker or colour profile backgrounds that require highly contrasted text"
          }},
...
surface : {level0:{
            ...
            name: "surface.interactiveActive",
            hex: "#E6EDF5",
...
primary : {textBase:{
            ...
            hex: "#C8D3E0",
            description: "Used for the border colour for primary components"
          },borderHover:{
            name: "primary.borderHover",
            hex: "#596D84",
            description: "Used for the hovered border colour for primary components"
          },borderActive:{
            name: "primary.borderActive",
            hex: "#2E3A47",
            description: "Used for the pressed border colour for primary components"
          }},
success : {textBase:{
...
info : {textBase:{
            ...
            name: "info.textHover",
            hex: "#21588F",
            description: "Used as the hovered colour for interactive informational components such as links and text buttons"
          },textActive:{
            name: "info.textActive",
            hex: "#194673",
            ...
            hex: "#88B1D9",
            description: "Used as the pressed muted background for informational components such as pills and text buttons. Paired with info.textBase for a subtler contrast"
          },backgroundBox:{
            name: "info.backgroundBox",
            hex: "#F5FAFF",
...
warning : {textBase:{
            name: "warning.textBase",
            hex: "#B4631D",
            description: "Used as the text or fill colour for interactive and static warning components such as links, text, and icons"
          },textHover:{
            name: "warning.textHover",
            hex: "#8E4D14",
            description: "Used as the hovered text or fill colour for interactive and static warning components such as links and text buttons"
          },textActive:{
            name: "warning.textActive",
            hex: "#784213",
            description: "Used as the pressed text or fill colour for interactive and static warning components such as links and text buttons"
          },backgroundBase:{
            name: "warning.backgroundBase",
            hex: "#B4631D",
            ...
            hex: "#E7B88F",
            description: "Used as the pressed muted background for warning components such as pills and text buttons. Paired with warning.textBase for a subtler contrast"
          },backgroundBox:{
            name: "warning.backgroundBox",
            hex: "#FFFAF5",
...
danger : {textBase:{
            name: "danger.textBase",
            hex: "#AF2645",
            description: "Used as the text or fill colour for interactive and static danger components such as links, text, and icons"
          },textHover:{
            name: "danger.textHover",
            hex: "#980B29",
            description: "Used as the hovered colour for interactive danger components such as links and text buttons"
          },textActive:{
            name: "danger.textActive",
            hex: "#800D25",
            description: "Used as the pressed colour for interactive danger components such as links and text buttons"
          },backgroundBase:{
            name: "danger.backgroundBase",
            hex: "#AF2645",
            ...
            hex: "#E296A6",
            description: "Used as the pressed muted background for danger components such as pills and text buttons. Paired with danger.textBase for a subtler contrast"
          },backgroundBox:{
            name: "danger.backgroundBox",
            hex: "#FFF7F9",
            description: "Used as a very light background for warning components such as Message and Box. Used for containers with content blocks"
          },borderBase:{
...
highlight : {textBase:{
            name: "highlight.textBase",
            hex: "#533E7D",
            description: "Used as the text or fill colour for interactive and static highlight components such as links, text, and icons"
          },textHover:{
            name: "highlight.textHover",
            hex: "#3B2566",
            ...
            hex: "#B9ABD5",
            description: "Used as the pressed muted background for highlight components such as pills and text buttons. Paired with highlight.textBase for a subtler contrast"
          },backgroundBox:{
            name: "highlight.backgroundBox",
            hex: "#FCFAFF",
...
input : {backgroundBase:{
            name: "input.backgroundBase",
            hex: "#F5F7FA",
            description: "Used as the default background colour for HTML inputs"
          },backgroundHover:{
            name: "input.backgroundHover",
            hex: "#E6EDF5",
            description: "Used as the hovered background colour for HTML inputs"
          },backgroundInformation:{
            name: "input.backgroundInformation",
            hex: "#FFFFFF",
            description: "Used as the default background colour for the text description below the input"
          },textBase:{
            name: "input.textBase",
            hex: "#475A70",
            ...
            hex: "#2E3A47",
            description: "Used as the label colour for labels that don't float when focused, like the select component"
          },borderBase:{
            name: "input.borderBase",
            hex: "#E6EDF5",
            description: "Used as the default border colour"
          },borderError:{
            name: "input.borderError",
            hex: "#AF2645",
            description: "Used for the border colour when the input is in an error state"
          },borderHover:{
            name: "input.borderHover",
            hex: "#C8D3E0",
...
accent : {sandMuted:{
            name: "accent.sandMuted",
            hex: "#F6F1E5",
            description: "Used for the backgrounds of elements that have the sand accent color"
          },forestText:{
            name: "accent.forestText",
            hex: "#275E43",
            description: "Used for the text within accent elements of forest type"
          }},};